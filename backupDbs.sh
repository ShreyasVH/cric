...
mysqldump -P $MYSQL_PLAY_SOURCE_PORT -u $MYSQL_PLAY_SOURCE_USER $MYSQL_PLAY_SOURCE_NAME -S $MYSQL_PLAY_SOURCE_SOCKET > "$HOME/dbBackups/$MYSQL_PLAY_SOURCE_NAME.sql"